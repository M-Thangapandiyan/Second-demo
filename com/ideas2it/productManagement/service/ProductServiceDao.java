...
import com.ideas2it.productManagement.util.exception.ProductManagementException;
 ...
 /**
  * This interface is used to call a ProductServiceImpl class metohds
  *
...
public interface ProductServiceDao {
     ...
     * @return productnames - if the name is present
     */
    public List<Product> searchProductById(String value) throws ProductManagementException;
      
    /**
     * This method is uesd to get given range values
     *
     * @param startDate - to get the details from 
     * @param endDate - to get the deatails till 
     *
